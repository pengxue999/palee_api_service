...
class DBAPIConnection(Protocol):
    ...
    .. seealso::
        ...
        `Connection Objects <https://www.python.org/dev/peps/pep-0249/
        - in :pep:`249`
...
class DBAPIType(Protocol):
    ...
    .. seealso::
        ...
        `Type Objects <https://www.python.org/dev/peps/pep-0249/
        - in :pep:`249`
...
class DBAPICursor(Protocol):
    ...
    .. seealso::
        ...
        `Cursor Objects <https://www.python.org/dev/peps/pep-0249/
        - in :pep:`249`
    ...
    def description(
        ...
        .. seealso::
            ...
            `cursor.description <https://www.python.org/dev/peps/pep-0249/
            - in :pep:`249`
