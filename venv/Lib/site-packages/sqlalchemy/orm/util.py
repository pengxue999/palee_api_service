...
def _entity_corresponds_to_use_path_impl(
    ...
    e.g.::
        ...
        someoption(A).someoption(A.b)
        someoption(A).someoption(C.d)

        a1 = aliased(A)
        someoption(a1).someoption(A.b)
        someoption(a1).someoption(a1.b)

        wp = with_polymorphic(A, [A1, A2])
        someoption(wp).someoption(A1.foo)
        someoption(wp).someoption(wp.A1.foo)
