...
.. _create_function: https://docs.python.org/3/library/sqlite3.html

.. _re.search: https://docs.python.org/3/library/re.html
...
pysqlite supports a `create_function() <https://docs.python.org/3/library/sqlite3.html
