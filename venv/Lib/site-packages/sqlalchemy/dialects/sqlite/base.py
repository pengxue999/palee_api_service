...
`"legacy transaction control" <https://docs.python.org/3/library/sqlite3.html
...
* **Enabling modern sqlite3 transaction control via the autocommit connect parameter** (Python 3.12 and above)
  ...
  To use SQLite in the mode described at `Transaction control via the autocommit attribute <https://docs.python.org/3/library/sqlite3.html
...
* `Transaction control <https://docs.python.org/3/library/sqlite3.html
...
.. seealso::
    ...
    `SQLite Internal Schema Objects <https://www.sqlite.org/fileformat2.html
    documentation.
