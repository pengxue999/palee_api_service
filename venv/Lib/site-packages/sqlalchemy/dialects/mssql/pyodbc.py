...
<https://github.com/mkleehammer/pyodbc/wiki/The-pyodbc-Module
...
.. seealso::
    ...
    `pooling <https://github.com/mkleehammer/pyodbc/wiki/The-pyodbc-Module
...
.. seealso::
    ...
    `fast executemany <https://github.com/mkleehammer/pyodbc/wiki/Features-beyond-the-DB-API
    - on github
